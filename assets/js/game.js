...
var getPlayerName = function() {
    ...
    while (name === "" || name === null) {
        name = prompt("What is our robot's name?");
    }
...
var playerInfo = {
    ...
    refillHealth: function() {
        if (this.money >= 7) {
            window.alert("Refilling " + this.name + "'s health by 20 for 7 dollars.");
            this.health += 20;
            this.money -= 7;
        } else {
    ...
    upgradeAttack: function() {
        if (this.money >= 7) {
            ...
            window.alert("Dang, " + this.name + ". You broke as hell!");
        }
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            // pass the pickedenemy.name variable's value into the fight function, where it will assume the alue of the enemy.name parameter
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                ...
                // if es, take them to the store() function
                if (storeConfirm) {
                    shop();
                }
            }
